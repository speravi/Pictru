...
export default function SuspendedImageCard({ image }: ImageCardProps) {
  return (
    <NavLink className="w-[400px] group relative" to={`/suspended/${image.id}`}>
      ...
      <div className="shadow-lg shadow-red-500/50 overflow-hidden object-contain">
