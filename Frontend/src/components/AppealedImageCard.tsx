...
//TODO: could reuse imagecard but g2g fast
export default function AppealedImageCard({ image }: ImageCardProps) {
  return (
    <NavLink className="w-[400px] group relative" to={`/appealed/${image.id}`}>
      ...
      <div className="shadow-lg shadow-yellow-500/50 overflow-hidden object-contain">
